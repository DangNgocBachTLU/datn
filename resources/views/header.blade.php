<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        ...
        {{-- trang chủ --}}
        <a class="navbar-brand" href="{{ route('homepage.index') }}">Trang chủ</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" role="search" method="GET" action="{{ route('test.search') }}">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-4">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="test" href="{{ route('test.list') }}">Đề thi</a>
                </li>
                ...
                @if(Auth::check())
                    <li class="nav-item dropdown custom-dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item test-history" href="{{ route('test.history') }}">Lịch sử làm bài</a></li>
                            <li>
